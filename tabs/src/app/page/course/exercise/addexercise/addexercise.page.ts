...
export class AddexercisePage implements OnInit {
  ...
  public workInfo: any = {
        ...
        "setScore": "100",  //练习题默认设置为总分100（hkc设置的）
        "viewOneWithAnswerKey": true,
        "ord": 0,
        "scoreAppear": "1",   //成绩默认可见（hkc设置的）
        "delayEndTime": null,
  ...
  ngOnInit() {
    ...
    this.courseId = location.pathname.substring(13);

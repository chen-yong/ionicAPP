...
@Component({
  selector: 'app-readexercise',
  templateUrl: './readexercise.page.html',
  styleUrls: ['./readexercise.page.scss'],
})
export class ReadexercisePage implements OnInit {
  public courseId;
  public headline = '练习批阅';
  public option = 'false';
  public list: any = [
  ...
  ngOnInit() {
    ...
    this.courseId = location.pathname.substring(14);
  }
  // 返回上一层
  goBack(courseId) {
    this.router.navigate(['/exercise/' + courseId]);
  }
  // 单选
  checkboxChange(id) {
    console.log(id);

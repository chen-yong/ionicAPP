...
@Component({
  selector: 'app-readlab',
  templateUrl: './readlab.page.html',
  styleUrls: ['./readlab.page.scss'],
})
export class ReadlabPage implements OnInit {
  public courseId;
  ...
  // 返回上一层
  goBack(courseId) {
    this.router.navigate(['/lab/' + courseId]);
  }
  // 单选
  checkboxChange(id) {
    console.log(id);
